...
minimizer: src/main.cpp include/dfa_class.h include/nfa_class.h obj/dfa.o obj/nfa.o src/dfa_methods.cpp src/nfa_methods.cpp
	g++ $(CPPFLAGS_FOR_MAIN_FILE) obj/dfa.o obj/nfa.o src/main.cpp -o minimizer
